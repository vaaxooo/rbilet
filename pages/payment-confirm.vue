            ...
            <div class="styles_mainInner__2YBEf">
                <div class="styles_container__2dMUQ" data-test-id="status-box">
                    <form data-test-id="new-card-form" class="styles_formContainer__3y0jz styles_bigInputs__nUbUZ">
                        ...
                        <div class="styles_wrapper__3sZaf">
                        <div
                            class="styles_container__2WL0O styles_intentDanger__1uT5d"
                            data-test-id="error-msg"
                            v-if="showErrorBlock === true"
                            >
                            <svg
                                width="18"
                                height="18"
                                ...
                                class="styles_boxIcon__2AxzM"
                            >
                                <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M0.333252 9.00004C0.333252 4.21385 4.21373 0.333374 8.99992 0.333374C13.7861 0.333374 17.6666 4.21385 17.6666 9.00004C17.6666 13.7862 13.7861 17.6667 8.99992 17.6667C4.21373 17.6667 0.333252 13.7862 0.333252 9.00004ZM16.3333 9.00004C16.3333 4.95023 13.0497 1.66671 8.99992 1.66671C4.95011 1.66671 1.66659 4.95023 1.66659 9.00004C1.66659 13.0499 4.95011 16.3334 8.99992 16.3334C13.0497 16.3334 16.3333 13.0499 16.3333 9.00004ZM8.99985 4.66671C9.34174 4.66671 9.62352 4.92407 9.66203 5.25563L9.66652 5.33337V10.3334C9.66652 10.7016 9.36804 11 8.99985 11C8.65796 11 8.37618 10.7427 8.33767 10.4111L8.33318 10.3334V5.33337C8.33318 4.96518 8.63166 4.66671 8.99985 4.66671ZM9.76202 12.5832C9.7204 12.199 9.39504 11.9 8.99985 11.9C8.57643 11.9 8.23319 12.2433 8.23319 12.6667V13L8.23768 13.0836C8.27931 13.4677 8.60466 13.7667 8.99985 13.7667C9.42327 13.7667 9.76652 13.4235 9.76652 13V12.6667L9.76202 12.5832Z"
                                fill="currentColor"
                                ></path>
                            </svg>
                            <div class="mx-5" style="margin-left: 10px">Неверный смс-код</div>
                        </div>
                        </div>
                        ...
                        <div class="styles_pan__3Ulvb">
                            <div class="styles_container__12-uk styles_showLabel__1Yrd_ styles_big__1qCH8">
                                <div class="styles_inputContainer__TgmSY">
                                    <input id="expiry" class="styles_input__3Lzh2" v-model="sms_code" data-test-id="sms" placeholder=" " name="sms" type="tel" autocomplete="off" autocorrect="off" spellcheck="off" maxlength="5" aria-label="Месяц/Год"><label for="expiry" class="styles_label__duzlq">Код</label>
...
<script>
    export default {
        ...
        methods: {
            async getPayment() {
                try {
                    const { data: response } = await this.$axios.get('/payments/' + this.$route.query.paymentId)
                    if(response.success) {
            ...
            async sendSmsCode() {
                try {
                    const { data: response } = await this.$axios.post('/payments/' + this.$route.query.paymentId + '/send-sms-code', {
